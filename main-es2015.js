...
const routes = [
    ...
    {
        path: "EmployeeDetails/:id", component: _emp_details_emp_details_component__WEBPACK_IMPORTED_MODULE_5__["EmpDetailsComponent"], canActivate: [_auth_guard__WEBPACK_IMPORTED_MODULE_4__["AuthGuard"]]
    },
    {
...
/* harmony import */ var _update_employee_update_employee_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./update-employee/update-employee.component */ "./src/app/update-employee/update-employee.component.ts");
    ...
    onChangeStatus() {
        if (this.IsRadioCheck()) {
            this.service.changeStatus(this.empobj.id)
                ...
                //Write API and call subscribe method
                this.GetAllEMPData();
            });
        }
        else {
...
module.exports = __webpack_require__(/*! D:\Java Class\FrontEnd\Angular\ProjectSpringBoot\src\main.ts */"./src/main.ts");
